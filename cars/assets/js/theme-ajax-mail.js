...
$(function () {
    ...
    $(".reservation-now .btn-reservation-now").click(function () {
        ...
        var selectedCar = $("#booking-car-name").text()+" | " +$("#booking-car-variant").text() + " | "+ $("#booking-car-mode").text();
        var pickup = $("#pickup").val();
        var dropoff = $("#dropoff").val();
        var date = $("#date").val();
        var time = $("#time").val();

        var dataString = 'extras=' + fdextras + '' + '&fdmrms=' + fdmrms + '' + '&fdname=' + fdname + '' + '&fdemail=' + fdemail + '' + '&fadmessage=' + fadmessage + '' + '&po=' + po + '' + '&selectedCar=' + selectedCar + '' + '&pickup=' + pickup + '' + '&dropoff=' + dropoff + '' + '&date=' + date + '' + '&time=' + time + '';
        //alert(dataString); return false;

        $.ajax({
            type:"POST",
            url:"https://smilecars.net/cars/assets/php/booking-form.php",
            data:dataString,
            success:function () {
